...
from ..ploting import plot_kernels
...
#
#         # final = (final_1 + final_2 + final_3 + final_4) / 4
#         final = torch.add(final_1, final_2)
#         final = torch.add(final, final_3)
#         final = torch.add(final, final_4)
...
class UNet_Nested(nn.Module):
    ...
    def forward(self, inputs):
        ...
        X_40 = self.conv40(maxpool3)  # 256*32*32
        # column : 1
        X_31 = self.up_concat31(X_40)
        # column : 2
        X_22 = self.up_concat22(X_31)
        # column : 3
        X_13 = self.up_concat13(X_22)
        # column : 4
        X_04 = self.up_concat04(X_13)
