...
if __name__ == "__main__":
    ...
    parser.add_argument("-c", "--continue_training", help="use this if you want to continue a training",
                        action="store_true")
    parser.add_argument("-p", help="plans identifier",
    ...
    parser.add_argument("--find_lr", required=False, default=False,
                        action="store_true", help="not used here, just for fun")
    parser.add_argument("--valbest", required=False, default=False,
                        action="store_true", help="hands off. This is not intended to be used")
    ...
    if unpack == 0:
        ...
        raise ValueError(
            "Unexpected value for -u/--unpack_data: %s. Use 1 or 0." % str(unpack))
    ...
    if network == "3d_cascade_fullres":
        ...
        assert issubclass(
            trainer_class, nnUNetTrainer), "network_trainer was found but is not derived from nnUNetTrainer"
    ...
    if find_lr:
        ...
        if valbest:
            ...
            val_folder = "validation_best_epoch" + config.val_name
        else:
            val_folder = "validation" + config.val_name
