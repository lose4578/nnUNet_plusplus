...
if __name__ == "__main__":
    ...
    nii_files_tr_data = os.listdir(img_dir)
    nii_files_tr_data.sort()
    nii_files_tr_seg = os.listdir(lab_dir)
    nii_files_tr_seg.sort()
    nii_files_ts = os.listdir(img_dir_te)
    nii_files_ts.sort()
    #p = Pool(8)
    ...
    #p.close()
    #p.join()
    train_ids = list(zip(nii_files_tr_data, nii_files_tr_seg))
    test_ids = list(nii_files_ts)
